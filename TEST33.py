...
def plot_measurements(tracks):
    for track in tracks:
        ...
        plt.scatter(times, measurements_x, label='Measurement X', color='blue')
        plt.scatter(times, Sf_x, label='Sf X', color='red', linestyle='--')
        plt.xlabel('Time')
        plt.ylabel('X Coordinate')
        plt.title(f'Track {track["track_id"]} X vs Time')
        plt.legend()
        plt.show()

        plt.figure(figsize=(10, 6))
        plt.scatter(times, measurements_y, label='Measurement Y', color='blue')
        plt.scatter(times, Sf_y, label='Sf Y', color='red', linestyle='--')
        plt.xlabel('Time')
        plt.ylabel('Y Coordinate')
        plt.title(f'Track {track["track_id"]} Y vs Time')
        plt.legend()
        plt.show()

        plt.figure(figsize=(10, 6))
        plt.scatter(times, measurements_z, label='Measurement Z', color='blue')
        plt.scatter(times, Sf_z, label='Sf Z', color='red', linestyle='--')
        plt.xlabel('Time')
        plt.ylabel('Z Coordinate')
        plt.title(f'Track {track["track_id"]} Z vs Time')
        plt.legend()
        plt.show()
